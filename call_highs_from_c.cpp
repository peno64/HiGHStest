...
void minimal_api_mps2() {
    ...
    const int num_col = Highs_getNumCol(highs);
    const int num_row = Highs_getNumRow(highs);
    ...
    assert(abs(objective_function_value - 31.78275862) < 1e-5);
}
